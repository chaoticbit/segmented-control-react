...
import './react-segmented-control.css';
...
export default class ReactSegmentedControl extends Component {
    constructor(...args) {
        var _temp;
...
ReactSegmentedControl.defaultProps = {
    onChangeSegment: x => x
};
ReactSegmentedControl.propTypes = {
